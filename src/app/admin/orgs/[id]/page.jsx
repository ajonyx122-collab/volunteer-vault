...
export default function AdminOrgDetail({ params }) {
  const { id } = use(params)
  ...
  if (notFound) {
    return (
      <div className="mx-auto max-w-md px-4 py-24 text-center sm:px-6">
        ...
        <Link href="/admin" className="mt-3 inline-block font-bold text-coral hover:underline">
          ← Back to admin
        </Link>
      </div>
    )
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      <Link href="/admin" className="text-sm font-semibold text-brand-green/60 hover:text-brand-green">
        ← Back to admin
      </Link>
